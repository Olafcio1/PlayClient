...
public class WPlayDropdown<T> extends WDropdown<T> implements PlayWidget {
    public WPlayDropdown(T[] values, T value) {
        super(values, value);
    }
    ...
    private static class WRoot extends WDropdownRoot implements PlayWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            PlayGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements PlayWidget {
        @Override
