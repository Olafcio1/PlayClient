package pl.olafcio.playclient.theme.widgets.input;
...
import pl.olafcio.playclient.theme.widgets.WPlayLabel;

public class WPlayTextBox extends WTextBox implements PlayWidget {
    private boolean cursorVisible;
    private double cursorTimer;

    private double animProgress;

    public WPlayTextBox(String text, String placeholder, CharFilter filter, Class<? extends Renderer> renderer) {
    ...
    private static class CompletionItem extends WPlayLabel implements ICompletionItem {
